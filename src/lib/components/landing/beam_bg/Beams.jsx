...
// This is a helper function from the source code to modify existing Three.js materials
...
// GLSL code for noise generation, taken from the source
const noise = `
...
// Helper function to create the geometry for all beams in one go
...
// Component that creates the merged geometry

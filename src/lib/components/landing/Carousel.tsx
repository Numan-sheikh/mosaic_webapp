...
const DEFAULT_ITEMS: CarouselItem[] = [
  {
    title: "Mosaic.",
    description: "A life in fragments, pieced together here.",
    id: 1,
    icon: <FiFileText className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Pieces.",
    description: "Every poem, photo, and quote is a tile in this collection.",
    id: 2,
    icon: <FiCircle className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Broken.",
    description: "Finding the beauty in life's scattered moments.",
    id: 3,
    icon: <FiLayers className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Design.",
    description: "My small attempt to find a pattern in it all.",
    id: 4,
    icon: <FiLayout className="h-[16px] w-[16px] text-white" />,
  },
  {
    title: "Grout.",
    description: "The quiet, reflective spaces between the pieces.",
    id: 5,
...
// ✅ Typed transition for Framer Motion v11+
